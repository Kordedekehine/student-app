...
import static com.studentunite.studentsapp.security.securityUtils.SecurityConstants.*;
...
public class TokenProviderServiceImpl implements Serializable, TokenProviderService {
    ...
    @Override
    public String generateLoginToken(Authentication authentication, AppUser user) {
